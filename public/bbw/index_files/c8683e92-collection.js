                ...
                ? (a && a.type
                      ? ((this.originalEvent = a),
                        ...
                        (this.isDefaultPrevented =
                            a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? aa : ba))
                      : (this.type = a),
                  b && m.extend(this, b),
            ...
            attr: function (a, b, c) {
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return typeof a.getAttribute === K
                        ? m.prop(a, b, c)
                        : ((1 === f && m.isXMLDoc(a)) ||
                              ((b = b.toLowerCase()), (d = m.attrHooks[b] || (m.expr.match.bool.test(b) ? nb : mb))),
                          void 0 === c
        ...
        (b.DEFAULTS = {
            ...
            (b.prototype.applyPlacement = function (a, b) {
                ...
                if (("top" == b && j != f && ((c = !0), (a.top = a.top + f - j)), /bottom|top/.test(b))) {
                    var k = 0;
                    a.left < 0 &&
                        ((k = -2 * a.left), (a.left = 0), d.offset(a), (i = d[0].offsetWidth), (j = d[0].offsetHeight)),
            ...
            (b.prototype.getTitle = function () {
                var a,
                    ...
                    c = this.options;
                return (a =
                    b.attr("data-original-title") || ("function" == typeof c.title ? c.title.call(b[0]) : c.title));
            }),
            ...
            (b.prototype.checkPosition = function () {
                if (this.$element.is(":visible")) {
                    ...
                    this.affixed !== i &&
                        ...
                        "bottom" == i &&
                            this.$element.offset({ top: document.body.offsetHeight - h - this.$element.height() }));
                }
            });
        var c = a.fn.affix;
...
//Fixes Bootstrap carousel, if jQuery and Mootools are active and '.carousel' is on page
//more info: https://github.com/joomla/joomla-cms/issues/475

if (typeof jQuery != "undefined") {
    jQuery(document).ready(function () {
        if (typeof MooTools != "undefined" && jQuery(".carousel").length > 0) {
...
$(document).ready(function () {
    $("ul.dropdown-menu li.dropdown-toggle > a").on("click", function (event) {
...
function DisplayRechnungsadresse() {
    $(".rechnung .checkbox").click(function () {
        if ($(".rechnung .checkbox").prop("checked")) {
            $(".kurs-extern.detail-formular .rechungsadresse").css("display", "none");
            $(".rechungsadresse input").prop("required", false);
        } else {
            $(".kurs-extern.detail-formular .rechungsadresse").css("display", "block");
            $(".rechungsadresse input").prop("required", true);
        }
    });
}

function showDays(days) {
    var kurstage = $("fieldset.kurstage");
...
function InsertMailtext() {
    $value = $("#mailtext").val();
    $("form .mailtext").prop("value", $value);
}

function InsertMailsender() {
    $value = $("#sender").val();
    $("form .sender").prop("value", $value);
}

function InsertKursname() {
    $value = $("#kurs").val();
    $("form .kurs").prop("value", $value);
    $category = $("#category").val();

    $("form .kategorie").prop("value", $category);
}

function InsertAlias() {
    $alias = $("#alias").val();
    $("form .kurs_alias").prop("value", $alias);
}

function InsertKursnummer() {
    $value = $("#kursnummer").val();
    $("form .kursnummer").prop("value", $value);
}

function countMembers() {
    $("#f1 .submit").click(function () {
        $("#output").html(function (i, val) {
            $oldclick = $("#mailsend").val();
            $click = val * oldclick + 1;
            $("#mailsend").val("$click");
        });
    });
}
function showMenu() {
    $("#trigger").click(function () {
        if ($(".mp-pusher").hasClass("mp-pushed")) {
            $(".scroller").css("left", 0);
            $("#header").css("left", 0);
            $(".navbar.mobile").css("margin-left", 0);
            $(".mp-pusher").removeClass("mp-pushed");
        } else {
            $(".scroller").css("left", 250);
            $("#header").css("left", 250);
            $(".navbar.mobile").css("margin-left", 250);
...
function openMenu() {
    $("#trigger").click(function () {
        ...
        if ($("body").hasClass("noscroll")) {
            ...
            $scrollTop = parseInt($(".scroller").css("top"), 10);
...
function setMobileMenu() {
    $(window).on("load resize", function (e) {
        $height = $("body").height();
        $(".mp-menu.mobile").css("min-height", $height);
        $(".mp-menu.mobile").css("max-height", $height);
    });
}
$(document).ready(function () {
    DisplayRechnungsadresse();
    InsertMailtext();
    InsertKursname();
    InsertKursnummer();
    countMembers();
